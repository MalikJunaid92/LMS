...
/* ✅ Safe component to render time-dependent values client-side only */
const SafeTimeAgo = ({ date }: { date: string }) => {
...
const CourseDetails = ({
  ...
  /* ✅ Handle client-only user loading to avoid SSR mismatch */
          ...
          <div className="w-full 800px:w-[65%] 800px:pr-5">
            ...
            <div className="w-full">
              <div className="800px:flex items-center">
                <Ratings rating={data?.ratings} />
                <h5 className="text-[25px] font-Poppins text-black dark:text-white ml-3">
                  {data?.ratings !== undefined && data?.ratings !== null
                    ...
                    <div className="flex">
                      ...
                      <div className="pl-2">
                        ...
                        <small className="text-[#000000d1] dark:text-[#ffffff83]">
                          <SafeTimeAgo date={item.createdAt} /> •
                        </small>
                      </div>
                    </div>
                      ...
                      <div className="w-full flex 800px:ml-16 my-5" key={i}>
                        ...
                        <div className="pl-2">
                          ...
                          <small className="text-[#ffffff83]">
                            <SafeTimeAgo date={reply.createdAt} /> •
                          </small>
                        </div>
                      </div>
                    ))}
